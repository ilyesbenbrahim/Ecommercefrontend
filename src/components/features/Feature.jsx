    ...
    <>
      <div className="feature-highlight">
        ...
        <div className="footer-text">
          ...
          <p>{t("feature:makeYourPurchasesWithEase")}</p>
          <div className="reserved">
            <h5>{t("feature:allRightsReserved")}</h5>
          </div>
        </div>

        <div className="about">
          <h3>{t("feature:about")} </h3>
          <Link className="lien" to="/methodesdepayement">
            <h4>{t("feature:paymentMethods")}</h4>
          </Link>
          <Link className="lien" to="/quisommesnous">
            <h7>{t("feature:whoAreWe")}</h7>
          </Link>
          <Link className="lien" to="/delivery">
            <h4>{t("feature:delivery")}</h4>
          </Link>
        </div>
        <div className="help">
          <h3>{t("feature:help")}</h3>
          <Link className="lien" to="/return">
            <h4>{t("feature:howToMakeAReturn")}</h4>
          </Link>
          <Link className="lien" to="/Pricesdeliverytimes">
