...
const AjouterUnProduit = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      await axios.post(
        "https://ecommercebackend-service.onrender.com/api/products",
        newProduct
      );
  ...
  return (
    <div className="container">
      ...
      <form onSubmit={handleSubmit} encType="multipart/form-data">
        ...
        <label htmlFor="prixduproduit">Prix du produit :</label>
        <br />
        <input
          type="number"
          id="prixduproduit"
        ...
        <label htmlFor="nbrProductSelled">Nombre de produits vendus :</label>
        <br />
        <input
          type="number"
          id="nbrProductSelled"
